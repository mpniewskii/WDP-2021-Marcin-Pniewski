...
def game_over():
    ...
    napis_high_score = czcionka_game_over.render("Twój high score to: " + str(high_score) + " całe te", 1, (0, 0, 0))
    instrukcje = czcionka_game_over.render("Naciśnij Y by wyjść!", 1, (0, 0, 0))
    SCREEN.blit(napis_game_over, (130, 10))
    SCREEN.blit(instrukcje, (140, 110))
    SCREEN.blit(napis_high_score, (130, 190))
    kordy.clear()
...
zwykle_jedzenie = pygame.image.load('zwykle_jedzenie.jpg').convert_alpha()
zwykle_jedzenie = pygame.transform.scale(zwykle_jedzenie, (20, 20))
